...
<div class="main-content">
    ...
    <h1 class="title fire">Rock & Roll 2023</h1>
    <h1 class="title fire">XXX EDITION</h1>
    ...
    <h2 class="main-location">Potosi - Bolivia</h2>
</div>
</div>
<div class="main-program">
    ...
    <div class="program">
        ...
        <div class="card-program">
            ...
            <h3 class="program-card-title">Merchandicing</h3>
...
const aboutView = `<section class="about">
<div class="main-info main-info-about">
    <div class="about-content">
        <h2 class="main-subtitle about-subtitle">"Hello! Rockers!"</h2>
        <h1 class="title title-about fire">Rock & Roll 2023</h1>
        <h1 class="title title-about fire">xxx EDITION</h1>
        <span class="underline"></span>
  ...
  artists.forEach((artist) => {
    ...
    <div class="artist-card">
      ...
      <div class="artist-card-content">
        ...
        <h5 class="artist-subtitle">${artist.date}</h5>
